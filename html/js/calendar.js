...
(function($) { // create private scope (inside you can use $ instead of jQuery)
            ...
            if (jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
                ...
                jQuery(this).click(function(ev) {
                    ...
                    if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
                        ...
                        var mySplitResult = initialDate.split("-");
                        initialDate = parseInt(mySplitResult[1], 10) + "/" + parseInt(mySplitResult[2], 10) + "/" + mySplitResult[0];
    ...
    jQuery.fn.simpleDatepicker.formatOutput = function(dateObj) {
        var return_month = dateObj.getMonth() + 1;
        if (return_month < 10)
            return_month = "0" + return_month;
        var return_day = dateObj.getDate();
        if (return_day < 10)
            return_day = "0" + return_day;
        return dateObj.getFullYear() + "-" + return_month + "-" + return_day;
    };
