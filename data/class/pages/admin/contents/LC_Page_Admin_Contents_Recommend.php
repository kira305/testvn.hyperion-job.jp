...
class LC_Page_Admin_Contents_Recommend extends LC_Page_Admin_Ex {
    ...
    function getRecommendProducts() {
        ...
        $col = 'dtb_products.name,dtb_products.main_list_image,dtb_products.employment_status,dtb_best_products.*';
        ...
        foreach ($arrProducts as $data) {
			if(strlen($data['employment_status']) > 0)
				$data['employment_status'] = str_split($data['employment_status']);
