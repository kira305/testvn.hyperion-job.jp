 ...
 */
class LC_Page_Admin_Job_SearchCustomer extends LC_Page_Admin_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'job/search_customer.tpl';
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam('pageno', 'search_pageno', INT_LEN, 'n', array('NUM_CHECK','MAX_LENGTH_CHECK'));
    }
