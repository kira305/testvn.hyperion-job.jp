...
class LC_Page_Admin_Basis_Seo extends LC_Page_Admin_Ex {
    ...
    function lfInitParam($mode, &$objFormParam) {
        ...
        $objFormParam->addParam('メタタグ:Description', 'description', LTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
    ...
    function lfGetSeoPageData() {
        ...
        return array(
            DEVICE_TYPE_PC          => $objLayout->getPageProperties(DEVICE_TYPE_PC, null, '(edit_flg = ? or edit_flg = ?)', array('1', '2')),
