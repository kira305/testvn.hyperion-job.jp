    ...
    function action() {
        ...
        switch ($this->getMode()) {
            ...
            default:
                ...
                $this->arrNews1 = $this->lfGetNews(SC_Query_Ex::getSingletonInstance());
                break;
        }
    }
