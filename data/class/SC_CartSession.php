 ...
 * @version $Id: SC_CartSession.php 21935 2012-06-21 06:02:41Z pineray $
 */
class SC_CartSession {
    ...
    function addProduct($product_class_id, $quantity) {
        ...
        // obo hiih uyd, yrdoo suuliin gants product l bh yostoi uchraas
        // ehleed shuud hoosloj bn
        $this->delAllProducts(1);
        ...
        if (!$find) {
            ...
            $this->cartSession[$productTypeId][$max+1]['quantity'] = 1;
