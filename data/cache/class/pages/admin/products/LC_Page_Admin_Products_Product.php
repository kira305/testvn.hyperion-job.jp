...
class LC_Page_Admin_Products_Product extends LC_Page_Admin_Products_Ex {
    ...
    function lfInitFormParam(&$objFormParam, $arrPost) {
        ...
        $objFormParam->addParam('薬局名', 'shipping_pharmacy', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('管理薬剤師名', 'pharmacist_name1', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('管理薬剤師名', 'pharmacist_name2', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('管理薬剤師(カナ)', 'pharmacist_kana1', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('管理薬剤師(カナ)', 'pharmacist_kana2', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('郵便番号', 'zip1', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('郵便番号', 'zip2', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('住所', 'addr1', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('住所', 'addr2', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('電話番号', 'tel1', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('電話番号', 'tel2', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('電話番号', 'tel3', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
		$objFormParam->addParam('雇用形態', 'employment_status', INT_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK'));
            ...
            $objFormParam->addParam(SALE_PRICE_TITLE, 'price02', STEXT_LEN, 'KVna', array('EXIST_CHECK', 'SPTAB_CHECK','MAX_LENGTH_CHECK'));
...
__EOF__;
    ...
    function lfRegistProduct(&$objUpFile, &$objDownFile, $arrList) {
        ...
        // 配列の添字を定義
        $checkArray = array('name', 'status', 'employment_status', 'work_location_flg',
