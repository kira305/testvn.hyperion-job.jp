...
class LC_Page_Admin_Customer_ClientCorporate extends LC_Page_Admin_Ex {
    ...
    function lfInitParam(&$objFormParam) {
		$objFormParam->addParam('企業ID', 'corporate_id', INT_LEN, 'n', array('MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('企業名', 'corporate_name', STEXT_LEN, 'KVa', array('EXIST_CHECK','SPTAB_CHECK','MAX_LENGTH_CHECK'));
        $objFormParam->addParam('薬局名', 'pharmacy_name', STEXT_LEN, 'KVa', array('SPTAB_CHECK','MAX_LENGTH_CHECK'));
        $objFormParam->addParam('薬局担当者名1', 'charge_firstname', STEXT_LEN, 'KVa', array('EXIST_CHECK','SPTAB_CHECK','MAX_LENGTH_CHECK'));
        $objFormParam->addParam('薬局担当者名2', 'charge_lastname', STEXT_LEN, 'KVa', array('EXIST_CHECK','SPTAB_CHECK','MAX_LENGTH_CHECK'));
		$objFormParam->addParam('薬局担当者名（カナ）1', 'charge_firstname_kana', STEXT_LEN, 'KVCa', array('EXIST_CHECK','SPTAB_CHECK','MAX_LENGTH_CHECK','KANA_CHECK'));
        $objFormParam->addParam('薬局担当者名（カナ）2', 'charge_lastname_kana', STEXT_LEN, 'KVCa', array('EXIST_CHECK','SPTAB_CHECK','MAX_LENGTH_CHECK','KANA_CHECK'));
        ...
        $objFormParam->addParam('店舗数', 'num_of_stores', INT_LEN, 'n', array('EXIST_CHECK','MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('薬歴', 'medication_his', INT_LEN, 'n', array('EXIST_CHECK','MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('薬剤師数', 'num_of_pharmacists', INT_LEN, 'n', array('EXIST_CHECK','MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('事務スタッフ', 'o_staff', INT_LEN, 'n', array('EXIST_CHECK','MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('メイン処方箋発行機関', 'main_authority', MTEXT_LEN, 'KVa', array('SPTAB_CHECK','MAX_LENGTH_CHECK'));
        $objFormParam->addParam('科目', 'kamoku', MTEXT_LEN, 'KVa', array('SPTAB_CHECK' ,'MAX_LENGTH_CHECK'));
        ...
        $objFormParam->addParam('休憩室', 'b_room', INT_LEN, 'n', array('EXIST_CHECK','MAX_LENGTH_CHECK', 'NUM_CHECK'));
        ...
        $objFormParam->addParam('最寄駅', 'nearest', MTEXT_LEN, 'KVa', array('SPTAB_CHECK','MAX_LENGTH_CHECK'));
        $objFormParam->addParam('必需品', 'necessities', MTEXT_LEN, 'KVa', array('SPTAB_CHECK','MAX_LENGTH_CHECK'));
        $objFormParam->addParam('周辺環境', 'environ', MTEXT_LEN, 'KVa', array('SPTAB_CHECK','MAX_LENGTH_CHECK'));
