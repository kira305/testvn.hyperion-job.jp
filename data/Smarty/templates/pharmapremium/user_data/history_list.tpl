...
<section id="undercolumn">
    <h2 class="keep">お仕事リスト <span>閲覧したお仕事</span></h2>

    <ul class="list_button">
        <li><a href="/user_data/keep_list.php">キープしたお仕事</a></li>
        <li class="here"><span>閲覧したお仕事</span></li>
        <li><a href="/user_data/entryhis_list.php">応募したお仕事</a></li>
    </ul>

    <div class="list_wrap_list clearfix mylistbox">

        <!--{if count($arrProduct) == 0}-->
        <p class="listpage_list_navi">閲覧したお仕事履歴はありません</p>
        <!--{else}-->
        <p class="listpage_list_navi">閲覧したお仕事履歴 <em><!--{$tpl_linemax}-->件</em>を表示しています。</p>
                                ...
                                <div class="list_area clearfix">
                                    ...
                                    <div class="list_bottom">
                                        <ul class="list_button_tab">
                                            <!--{if in_array($item.product_id, $smarty.session.keep_product_list)}-->
                                            <li class="list_button_keep"><button class="list_button keep_off" type="button" onClick=""><span>キープ済です</span></button></li>
                                            <!--{else}-->
                                            <li class="list_button_keep"><button class="list_button keep_on" type="button" onClick="javascript:fnModeSubmit('cart', 'product_id', '<!--{$item.product_id}-->');"><span>キープしておく</span></button></li>
                                            <!--{/if}-->
