<style>
    ...
    div#entry_form input[class="col3"]::-webkit-input-placeholder { font-size: 60%; color: red; }
    div#entry_form input[class="col3"]::-moz-placeholder { font-size: 60%; color: red; }
    div#entry_form input[class="col3"]:-moz-placeholder { font-size: 60%; color: red; }
    div#entry_form input[class="col3"]:-ms-input-placeholder { font-size: 60%; color: red; }
    ...
    <form name="form_check" id="form_check" method="post" action="?">
        ...
        <div id="entry_form">
            ...
            <div class="list_wrap_list clearfix">
                ...
                <!-- div class="list_wrap list_wrap_entry clearfix" style="text-align: left" -->
                <div class="clearfix" style="text-align: left">
                    ...
                    <dl>
                        ...
                        <dt class="sml"><span>必須</span> 希望するパスワード</dt>
                        <dd>
