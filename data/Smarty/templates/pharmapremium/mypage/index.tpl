        ...
        <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->mypage/index.php">
            ...
            <!--{if $objNavi->all_row > 0}-->
                ...
                <div class="information">
                    <p><span class="attention"><span id="historycount"><!--{$objNavi->all_row}--></span>件</span>の応募履歴があります。</p>
                </div>
                ...
                <div class="form_area">
                    ...
                    <div class="formBox">
                        <!--{section name=cnt loop=$arrOrder max=$dispNumber}-->
                            <!--▼商品 -->
                            <div class="arrowBox" data-order_id="<!--{$arrOrder[cnt].order_id}-->">
                                <p>
                                    <em>応募番号：</em><span class="order_id"><!--{$arrOrder[cnt].order_id}--><!--{assign var=payment_id value="`$arrOrder[cnt].payment_id`"}--></span><br />
                                    <em>応募日時：</em><span class="create_date"><!--{$arrOrder[cnt].create_date|sfDispDBDate}--></span><br />
                                    <em>時給：</em><span class="payment_total"><!--{$arrOrder[cnt].payment_total|number_format}--></span>円
                                </p>
                ...
                <div class="btn_area" style="padding: 0">
...
<script>
    ...
    $(function(){
        $('.arrowBox').click(function(){
            location.href = "<!--{$smarty.const.ROOT_URLPATH}-->mypage/history.php?order_id=" + $(this).data("order_id");
        })
    });
