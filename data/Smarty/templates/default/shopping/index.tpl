...
<div id="undercolumn">
    <div id="undercolumn_login">
	 ...
	 <!--{if $direct == 'on'}--><input type="hidden" name="direct" value="on"><!--{/if}-->
        ...
        <div class="login_area">
            ...
            <div class="inputbox">
                <div class="btn_area">
                    <ul>
                        <li>
                            <a href="<!--{$smarty.const.ROOT_URLPATH}-->user_data/useful.php?from=shopping" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_on.jpg','b_gotoentry');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry.jpg','b_gotoentry');">
