...
<tr>
    ...
    <td>
        ...
        <p class="zipimg">
            <a href="<!--{$smarty.const.ROOT_URLPATH}-->entry/input_zip.php" onclick="fnCallAddress('<!--{$smarty.const.ROOT_URLPATH}-->entry/input_zip.php', '<!--{$key1}-->', '<!--{$key2}-->', '<!--{$key3}-->', '<!--{$key4}-->'); return false;" target="_blank">
...
<!--{if $flgFields > 1}-->
    ...
    <tr>
        ...
        <td>
            ...
            <!--{/if}-->
			<!--{html_checkboxes name=$key1 options=$arrEMPSTATUS separator='&nbsp;&nbsp;' selected=$arrForm[$key1]}--><br>
			<span class="attention mini">スポット派遣は、生業収入が500万円以上、世帯収入が500万円以上の場合に限ります。</span>
        </td>
    </tr>
    <tr>
