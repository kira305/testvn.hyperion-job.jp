...
<div id="customer" class="contents-main">
    ...
    <form name="form1" id="form1" method="post" action="?">
        ...
        <div class="btn">
            ...
            <a class="btn-normal" href="javascript:;" onclick="location.href = '../contents/csv.php?tpl_subno_csv=corporate'">CSV 出力項目設定</a>
        </div>
        <!--{if count($arrData) > 0}-->
        ...
        <table class="list" id="customer-search-result">
            ...
            <tr>
                <td class="center" rowspan="2"><!--{$agencyList[$row.agency_id]|h}--></td>
