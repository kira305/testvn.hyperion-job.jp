    ...
    <div id="customer" class="contents-main">
        <table class="form">
            ...
            <tr>
                <th>スタッフID</th>
                <td>
                    <span class="attention"><!--{$arrErr.staff_id}--></span>
                    <input type="text" name="staff_id" value="<!--{$arrForm.staff_id|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="30" class="box30" <!--{if $arrErr.staff_id != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>最寄駅</th>
                <td>
                    <span class="attention"><!--{$arrErr.metro_name}--><!--{$arrErr.bus_stop}--></span>
                    <input type="text" name="metro_name" value="<!--{$arrForm.metro_name|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="30" class="box30" <!--{if $arrErr.metro_name != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />線 &nbsp;&nbsp;<input type="text" name="bus_stop" value="<!--{$arrForm.bus_stop|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="30" class="box30" <!--{if $arrErr.bus_stop != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />駅
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{html_checkboxes name="job" options=$arrEMPSTATUS selected=$arrForm.job}-->
                </td>
            </tr>
            <tr>
                <th>生年月日</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="price" value="<!--{$arrForm.price|h}-->" size="30" class="box30" <!--{if $arrErr.price != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> /> 円
                </td>
            </tr>
            <tr>
                <th>社会ステータス<span class="attention"> *</span></th>
                <td>
                    <span class="attention"><!--{$arrErr.social_status}--></span>
                    <span <!--{if $arrErr.social_status != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="social_status" options=$arrSocialStatus separator=" " selected=$arrForm.social_status}-->
                    </span>
                </td>
            </tr>
            <tr>
                <th>国籍</th>
                <td>
                    <span class="attention"><!--{$arrErr.nationality}--></span>
                    <input type="text" name="nationality" value="<!--{$arrForm.nationality|h}-->" size="60" class="box60" <!--{if $arrErr.nationality != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />
                </td>
            </tr>
            <tr>
                <th>ビザの種類</th>
                <td>
                    <span class="attention"><!--{$arrErr.visa_type}--></span>
                    <span <!--{if $arrErr.visa_type != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="visa_type" options=$arrVisaType separator=" " selected=$arrForm.visa_type}-->
                    </span>
                </td>
            </tr>
            <tr>
                <th>給与明細発行形態</th>
                <td>
                    <span class="attention"><!--{$arrErr.salary_issued}--></span>
                    <span <!--{if $arrErr.salary_issued != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="salary_issued" options=$arrSalaryIssued separator=" " selected=$arrForm.salary_issued}-->
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span <!--{if $arrErr.salary_type != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="salary_type" options=$arrSalaryType separator=" " selected=$arrForm.salary_type}-->
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>受信メール種類設定</th>
                <td>
                    <span class="attention"><!--{$arrErr.incoming_mail_type}--></span>
                    <!--{html_checkboxes name="incoming_mail_type" options=$arrIncomingMailType selected=$arrForm.incoming_mail_type}-->
                </td>
            </tr>
            <tr>
