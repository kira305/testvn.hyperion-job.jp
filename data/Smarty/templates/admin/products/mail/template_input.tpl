...
<div id="mail" class="contents-main">
    <table class="form">
        ...
        <tr>
            <th>管理タイトル</th>
            <td>
                <input type="text" name="kanrititle" size="65" class="box65" <!--{if $arrErr.kanrititle}--><!--{sfSetErrorStyle}--><!--{/if}--> value="<!--{$arrForm.kanrititle|h}-->" />
                <!--{if $arrErr.kanrititle}--><br /><span class="attention"><!--{$arrErr.kanrititle}--></span><!--{/if}-->
            </td>
        </tr>
        <tr>
