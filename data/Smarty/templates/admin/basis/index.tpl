...
<div id="basis" class="contents-main">
    ...
    <table summary="基本情報" id="basis-index-basis">
        ...
        <tr>
            <th>許可番号</th>
            <td>
                <span class="attention"><!--{$arrErr.license_num}--></span>
                <input type="text" name="license_num" value="<!--{$arrForm.license_num|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="60" class="box60" style="<!--{if $arrErr.license_num != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" />
                <span class="attention"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
            <th>派遣元責任者</th>
            <td>
                <span class="attention"><!--{$arrErr.manager}--></span>
                <input type="text" name="manager" value="<!--{$arrForm.manager|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="60" class="box60" style="<!--{if $arrErr.manager != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" />
                <span class="attention"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
            </td>
        </tr>
        <tr>
