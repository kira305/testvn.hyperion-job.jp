                    ...
                    <td>
                        <div id="table-wrap" class="clearfix">
                            ...
                            <div class="table-detail">
                                <div class="detail-name">商品名： <!--{$arrItems[$smarty.section.cnt.iteration].name|h}--><br>
									<!--{if count($arrItems[$smarty.section.cnt.iteration].employment_status) > 0}-->
										<div style="float: left;">雇用形態：&nbsp;</div>
										<div style="float: left; width: 88%;"><ul>
					                        <!--{foreach from=$arrItems[$smarty.section.cnt.iteration].employment_status item=status}-->
					                            <li style="list-style-type: none; display: inline;"><img src="<!--{$TPL_URLPATH}--><!--{$arrEMPSTATUS_IMAGE[$status]}-->" width="60" height="17" alt="<!--{$arrEMPSTATUS[$status]}-->"/></li>
					                        <!--{/foreach}-->
					                    </ul></div>
					                <!--{/if}-->
									<!--{$smarty.const.SALE_PRICE_TITLE}-->： <span class="price"><!--{$arrItems[$smarty.section.cnt.iteration].price02_min_inctax}--> 円</span>
								</div>
