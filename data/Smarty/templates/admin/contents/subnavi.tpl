...
<li<!--{if $tpl_subno == 'csv'}--> class="on"<!--{/if}--> class="on_level2" id="navi-contents-csv"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->contents/csv.php"><span>CSV出力項目設定</span></a>
    ...
    <li<!--{if $tpl_subno_csv == 'corporate'}--> class="on"<!--{/if}--> id="navi-csv-corporate"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->contents/csv.php?tpl_subno_csv=corporate"><span>クライアント</span></a></li>
    <li<!--{if $tpl_subno_csv == 'prepayment'}--> class="on"<!--{/if}--> id="navi-csv-prepayment"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->contents/csv.php?tpl_subno_csv=prepayment"><span>前払い申請</span></a></li>
    <li<!--{if $tpl_subno_csv == 'staff'}--> class="on"<!--{/if}--> id="navi-csv-staff"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->contents/csv.php?tpl_subno_csv=staff"><span>社員管理</span></a></li>
    <li<!--{if $tpl_subno_csv == 'possibledate'}--> class="on"<!--{/if}--> id="navi-csv-possibledate"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->contents/csv.php?tpl_subno_csv=possibledate"><span>就業可能日管理</span></a></li>
