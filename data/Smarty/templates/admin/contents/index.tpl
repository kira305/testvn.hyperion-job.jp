...
<input type="hidden" name="term" value="" />
    ...
    <table>
        <tr>
            <th>おすすめ情報フラグ<span class="attention"> *</span></th>
            <td>
                <!--{if $arrErr.rec_news_flg}--><span class="attention"><!--{$arrErr.rec_news_flg}--></span><!--{/if}-->
    ...
    <table class="list">
        ...
        <tr style="background:<!--{if $arrNews[data].news_id != $tpl_news_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->;" class="center">
            ...
            <td><!--{assign var=flg value="`$arrNews[data].rec_news_flg`"}--><!--{$arrRECNEWSFLG[$flg]}--></td>
            <td class="left">
