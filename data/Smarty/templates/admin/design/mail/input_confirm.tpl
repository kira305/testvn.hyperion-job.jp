...
<form name="form1" id="form1" method="post" action="?">
    ...
    <input type="hidden" name="send_id" value="<!--{$arrForm.send_id.value|h}-->">
    <input type="hidden" name="cid" value="<!--{$arrForm.cid.value|h}-->">
    ...
    <div id="mail" class="contents-main">
        <table class="form">
            <tr>
                <th>管理タイトル</th>
                <td><!--{$arrForm.kanrititle.value|h}--></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><a href="javascript:;" onClick="winSubmitMail('', 'form2', 'preview', 650, 700);
        return false;">HTMLで確認</a>
            </tr>
            <!--{/if}-->
            <tr>
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" name="subm02" onclick="return fnInsertValAndSubmit(document.form1, 'mode', 'regist_back', '');
        return false;"><span class="btn-prev">テンプレート設定画面へ戻る</span></a></li>
                <li><a class="btn-action" href="javascript:;" name="subm03" onClick="return fnInsertValAndSubmit(document.form1, 'mode', 'regist_complete', '');
        return false;"><span class="btn-next">配信する</span></a></li>
            </ul>
        </div>
    </div>
</form>
