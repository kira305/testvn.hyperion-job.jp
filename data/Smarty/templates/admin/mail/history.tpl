    ...
    <div id="mail" class="contents-main">
        <table class="list center">
            ...
            <tr>
				...
				<td><a href="javascript:;" onclick="win03('./preview.php?mode=history&send_id=<!--{$arrDataList[cnt].send_id|h}-->&<!--{$smarty.const.TRANSACTION_ID_NAME}-->=<!--{$transactionid}-->', 'confirm', '720', '600', {menubar:'no'}); return false;">確認</a></td>
				<td><a href="javascript:;" onclick="win03('./<!--{$smarty.const.DIR_INDEX_PATH}-->?mode=query&send_id=<!--{$arrDataList[cnt].send_id|h}-->&<!--{$smarty.const.TRANSACTION_ID_NAME}-->=<!--{$transactionid}-->','query','615','800',{menubar:'no'}); return false;">確認</a></td>

                <td><a href="javascript:;" onclick="win03('./<!--{$smarty.const.DIR_INDEX_PATH}-->?mode=customer&amp;send_id=<!--{$arrDataList[cnt].send_id|h}-->','confirm','615','400'); return false;">確認</a></td>
                ...
                <td><a href="index.php?mode=retry&amp;send_id=<!--{$arrDataList[cnt].send_id|h}-->">再送</a></td>
