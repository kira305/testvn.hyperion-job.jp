...
final class PLG_Helper_Basis_Kiyaku extends PLG_Helper_Base {
    ...
    public function main($objPage){
        ...
        // ランク情報を合わせて取得
        $objPage->arrKiyaku = $this->lfGetKiyakuList();
        $objPage->sortCount = count($objPage->arrKiyaku);
    }
     ...
     * 規約一覧の取得.
     *
     * @see LC_Page_Admin_Basis_Kiyaku#lfGetKiyakuList
     * @return array
     */
    private function lfGetKiyakuList() {
        $objQuery =& SC_Query_Ex::getSingletonInstance();

        // rankを取得カラムに追加
        $where = 'del_flg <> 1';
        $objQuery->setOrder('rank DESC');
        return $objQuery->select('kiyaku_title, kiyaku_text, kiyaku_id, rank', 'dtb_kiyaku', $where);
    }
