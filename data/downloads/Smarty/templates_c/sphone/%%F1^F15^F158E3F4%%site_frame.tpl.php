...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'site_frame.tpl', 24, false),array('modifier', 'h', 'site_frame.tpl', 24, false),array('modifier', 'strlen', 'site_frame.tpl', 69, false),array('modifier', 'count', 'site_frame.tpl', 92, false),)), $this); ?>
<!DOCTYPE HTML>

<html lang="ja" class="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_page_class_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
">
    <head>
        <meta charset="UTF-8">
...
js/news.js"></script>
                ...
                <link rel="stylesheet" media="only screen" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/jquery.mobile/jquery.mobile-1.0.1.min.css" />
        <script src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/config.js"></script>
        <script src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/jquery.mobile/jquery.mobile-1.0.1.min.js"></script>
