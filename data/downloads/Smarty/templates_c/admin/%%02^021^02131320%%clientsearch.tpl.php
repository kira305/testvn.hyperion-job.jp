<?php /* Smarty version 2.6.26, created on 2012-10-09 13:02:46
         compiled from customer/clientsearch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/clientsearch.tpl', 49, false),array('modifier', 'h', 'customer/clientsearch.tpl', 61, false),array('function', 'sfSetErrorStyle', 'customer/clientsearch.tpl', 61, false),array('function', 'html_options', 'customer/clientsearch.tpl', 107, false),)), $this); ?>
...
<?php endif; ?> /></td>
			...
			<th>薬局名</th>
		    <td>
		        <?php $this->assign('key', 'search_pharmacy_name'); ?>
		        <?php if (((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span><br /><?php endif; ?>
		    	<input type="text" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" maxlength="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['length'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
?>
            <tr>
				...
				<td class="center" rowspan="2"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row']['pharmacy_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
