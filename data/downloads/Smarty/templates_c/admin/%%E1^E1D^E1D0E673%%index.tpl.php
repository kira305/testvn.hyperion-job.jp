<?php /* Smarty version 2.6.26, created on 2012-10-15 13:03:45
         compiled from products/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/index.tpl', 61, false),array('modifier', 'h', 'products/index.tpl', 74, false),array('modifier', 'sfGetErrorColor', 'products/index.tpl', 74, false),array('modifier', 'sfNoImageMainList', 'products/index.tpl', 246, false),array('modifier', 'number_format', 'products/index.tpl', 262, false),array('modifier', 'sfTrimURL', 'products/index.tpl', 270, false),array('modifier', 'sfTrim', 'products/index.tpl', 282, false),array('modifier', 'count', 'products/index.tpl', 296, false),array('function', 'html_options', 'products/index.tpl', 102, false),array('function', 'html_checkboxes', 'products/index.tpl', 109, false),)), $this); ?>
 ...
 ?>
        ...
        <table class="list" id="products-search-result">
            ...
            <tr>
                ...
                <th rowspan="2">画像</th>
                <th rowspan="2">求人コード</th>
                <th rowspan="2">給与(円)</th>
                <th>求人名</th>
                <th rowspan="2">募集人数</th>
                <th rowspan="2">種別</th>
                <th rowspan="2">編集</th>
                <th rowspan="2">確認</th>
...
&amp;width=65&amp;height=65">            </td>
                    <td rowspan="2"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['product_code_min'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
                        ...
                        <?php echo ((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['price02_min'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
                        ...
                        <?php if (((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['price02_min'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['price02_max'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                            <br />～ <?php echo ((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['price02_max'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
