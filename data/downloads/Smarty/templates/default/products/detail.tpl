...
<div id="undercolumn">
    ...
    <div id="detailarea" class="clearfix">
        ...
        <div id="detailrightbloc">
            ...
            <!--{if $tpl_stock_find}-->
                ...
                <dl class="quantity">
                    <dt></dt>
                    <dd><input type="hidden" class="box60" name="quantity" value="<!--{$arrForm.quantity.value|default:1|h}-->" maxlength="<!--{$smarty.const.INT_LEN}-->" style="<!--{$arrErr.quantity|sfGetErrorColor}-->" />
                        <!--{if $arrErr.quantity != ""}-->
                ...
                <div class="cartin">
                    <div class="cartin_btn">
                        <div id="cartbtn_default">
                            ...
                            <input type="image" onclick="javascript:fnModeSubmit('cart_to_shopping');" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_buystep_on_p.gif',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_buystep_p.gif',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_buystep_p.gif" alt="応募手続きへ" name="confirm" />

                            <!--★カゴに入れる★-->
                            <a href="javascript:void(document.form1.submit())" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_job_cartin_on.jpg','cart');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_job_cartin.jpg','cart');">
                                <img src="<!--{$TPL_URLPATH}-->img/button/btn_job_cartin.jpg" alt="カゴに入れる" name="cart" id="cart" /></a>
    ...
    <!--{section name=cnt loop=$smarty.const.PRODUCTSUB_MAX}-->
        <!--{assign var=sub_no value="`$smarty.section.cnt.index+1`"}-->
        <!--{assign var=key value="sub_comment`$smarty.section.cnt.index+1`"}-->
        <!--{if $arrProduct[$key] != ""}-->
            <div class="sub_area clearfix">
                <h3><!--★サブタイトル★--><!--{$arrSUBTITLE[$sub_no]|h}--></h3>
                <p class="subtext"><!--★サブテキスト★--><!--{$arrProduct[$key]|nl2br_html}--></p>
            </div>
        <!--{/if}-->
    <!--{/section}-->
    <!--▲サブコメント-->
    ...
    <!--{if $arrRecommend}-->
        <div id="whobought_area">
            <h2><img src="<!--{$TPL_URLPATH}-->img/title/tit_job5_product_recommend.gif" alt="その他のオススメ商品" /></h2>
