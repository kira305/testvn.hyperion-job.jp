...
<li<!--{if $tpl_subno == 'clientsearch'}--> class="on"<!--{/if}--> id="navi-customer-clientsearch"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->customer/clientsearch.php"><span>クライアントマスター</span></a></li>
<li<!--{if $tpl_subno == 'clientcorporate'}--> class="on"<!--{/if}--> id="navi-customer-clientcorporate"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->customer/clientcorporate.php"><span>クライアント登録</span></a></li>
</ul>
